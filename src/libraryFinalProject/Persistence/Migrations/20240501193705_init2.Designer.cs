...
namespace Persistence.Migrations
{
    ...
    [Migration("20240501193705_init2")]
    partial class init2
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Domain.Entities.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("898f363b-95f8-4f22-ade4-717cbe68711f"),
                            AuthenticatorType = 0,
                            CreatedDate = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            Email = "narch@kodlama.io",
                            PasswordHash = new byte[] { 128, 245, 245, 112, 56, 212, 160, 127, 13, 109, 120, 24, 134, 250, 255, 128, 82, 183, 251, 160, 110, 136, 249, 155, 67, 193, 75, 213, 60, 40, 230, 100, 151, 176, 66, 146, 26, 176, 59, 193, 25, 43, 158, 251, 141, 0, 18, 35, 167, 122, 66, 243, 49, 239, 239, 246, 16, 119, 246, 193, 14, 66, 228, 69 },
                            PasswordSalt = new byte[] { 143, 37, 92, 84, 188, 135, 185, 143, 242, 135, 83, 141, 46, 135, 117, 185, 212, 174, 139, 199, 162, 36, 229, 22, 87, 78, 169, 248, 7, 239, 212, 115, 156, 26, 95, 114, 61, 134, 183, 245, 12, 205, 5, 194, 34, 106, 89, 222, 81, 116, 235, 23, 235, 35, 8, 224, 142, 13, 169, 245, 64, 176, 244, 241, 67, 86, 63, 109, 134, 28, 251, 189, 103, 138, 183, 15, 131, 162, 191, 212, 45, 59, 3, 213, 209, 65, 188, 156, 74, 6, 118, 170, 94, 29, 83, 28, 178, 25, 99, 68, 227, 137, 75, 230, 146, 205, 209, 121, 222, 0, 79, 167, 181, 216, 126, 183, 158, 149, 162, 89, 216, 3, 126, 128, 224, 76, 66, 116 }
                        });
                });
            ...
            modelBuilder.Entity("Domain.Entities.UserOperationClaim", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("0b338d31-bb7b-447a-82df-f4882a20a262"),
                            CreatedDate = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            OperationClaimId = 1,
                            UserId = new Guid("898f363b-95f8-4f22-ade4-717cbe68711f")
                        });
                });
