...
namespace Persistence.Migrations
{
    ...
    [Migration("20240515143048_inittt")]
            ...
            modelBuilder.Entity("Domain.Entities.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("880c74e9-6c9b-44c7-8160-0889603d455e"),
                            AuthenticatorType = 0,
                            CreatedDate = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            Email = "narch@kodlama.io",
                            PasswordHash = new byte[] { 163, 81, 134, 15, 136, 129, 217, 220, 237, 55, 85, 50, 203, 202, 8, 29, 67, 158, 12, 230, 66, 64, 65, 143, 147, 156, 131, 238, 33, 19, 124, 41, 75, 255, 250, 96, 226, 45, 53, 222, 126, 158, 102, 157, 252, 175, 138, 17, 251, 64, 176, 76, 188, 75, 9, 127, 144, 213, 170, 33, 243, 28, 81, 116 },
                            PasswordSalt = new byte[] { 179, 13, 155, 60, 102, 176, 30, 7, 164, 229, 91, 182, 218, 109, 226, 1, 72, 51, 118, 130, 238, 220, 168, 220, 149, 177, 151, 189, 128, 53, 213, 131, 110, 184, 200, 164, 117, 60, 130, 95, 130, 114, 33, 88, 134, 14, 11, 133, 31, 50, 32, 222, 83, 216, 181, 1, 120, 29, 85, 81, 226, 19, 106, 85, 55, 142, 139, 31, 201, 123, 103, 161, 87, 9, 171, 73, 65, 221, 174, 86, 46, 161, 208, 38, 167, 223, 168, 133, 139, 167, 83, 22, 209, 29, 60, 138, 245, 46, 117, 223, 13, 113, 133, 113, 49, 60, 99, 142, 243, 131, 50, 62, 194, 119, 33, 75, 50, 117, 46, 180, 158, 6, 43, 220, 32, 246, 220, 139 }
                        });
                });
            ...
            modelBuilder.Entity("Domain.Entities.UserOperationClaim", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("06e8776b-e5c3-443f-899d-3b174fcc0f58"),
                            CreatedDate = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            OperationClaimId = 1,
                            UserId = new Guid("880c74e9-6c9b-44c7-8160-0889603d455e")
                        });
                });
